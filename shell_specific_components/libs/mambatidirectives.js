...
(function (mamDirectives) {
    ...
    function appshortcutComponentFunc2($rootScope, $scope, $element, $state, $location, $mdDialog, $mdToast) {
        ...
        $scope.singleClick = function (ev) {
            ...
            $rootScope.opendAppName = $scope.componentdata.Name;
            $rootScope.opendAppID = $scope.componentdata.ApplicationID;
        ...
        appInfoController.$inject = ['$scope', 'selectedAppInfo'];
    ...
    function appbundleComponentFunc() {
        return {
            ...
            template: '<md-menu  md-theme="docs-dark" flex-sm="30" flex-md="20" flex-lg="20" flex-gt-lg="20" style="padding:0px;height:200px;max-width:100%;" layout="column" layout-align="start center">' +
                '<md-button ng-click="$mdOpenMenu()">' +
                '<div class="appShorcutContainer">' +
                '<div class="md-applicationIcon-icon-section">' +
                '<img ng-src="{{componentdata.iconUrl}}" err-src="images/appIcons/untitledapplication.png" width="59" height="59">' +
                '</div>' +
                '<div class="md-applicationIcon-appname-section">{{componentdata.Name}}</div>' +
                '</div>' +
                '</md-button>' +
                '<md-menu-content width="4" layout="row" layout-align="start start" layout-wrap>' +
                '<div ng-repeat="c in componentdata.Apps" appshortcut-component componentdata="c" flex-sm="50" style="padding:10px;height:200px;">' +
                '</div>' +
                '</md-menu-content>' +
                '</md-menu>'
        };
