...
?>
    ...
    <head>
        ...
        <title>CloudCharge</title>
        <link rel="shortcut icon" href="images/tennantassets/cloudchargelogo_icon_blue.png" type="image/png">
    ...
    <body ng-app="mambatiFrameworkShell" layout="column" ng-cloak>
        ...
        <div id="dw-loadingFrame" style="background-image: url(./images/shellassets/background/background.jpg);" layout="column" layout-align="center center">
            <!--
...
-->
            ...
            <img src="images/tennantassets/cloudchargelogo.png">
            <!--            <p style="font-size:50px;color:white;">CloudCharge</p>-->
                ...
                <md-toolbar class="md-toolbar-medium" style="z-index:4 !important;">
                    <div class="md-toolbar-tools" layout="row" layout-align="space-between center">
                        <div class="tool-bar-control-set left" layout="row" layout-align="start center">
                            <!--                            <shell-branding id="shellBranding" ng-src="images/tennantassets/cloudchargelogo.png" ng-click="toggleLeftMenu()"></shell-branding>-->
                            <img src="images/tennantassets/cloudchargelogo.png" ng-click="toggleLeftMenu()" width="150px;" style="padding:0px 15px;">
                        </div>
                        ...
                        <div class="tool-bar-control-set right" layout="row" layout-align="end center">
                            ...
                            <md-menu md-position-mode="target-right target" class="user-profile-mdmenu">
                                <md-button class="md-accent md-icon-button" ng-click="$mdOpenMenu()" aria-label="profile">
                                    <!-- <img ng-src="{{$root.profilePicture}}" err-src="images/appIcons/contacts.png" width="32" height="32" style="border-radius:50%;"> -->
                                    <md-icon md-svg-icon="icons/ic_person_48px.svg" alt="User Profile"></md-icon>
                                </md-button>
                                <md-menu-content style="height:100%;max-height:400px;  padding:0px !important;" width="4" class="md-primary" layout="column" layout-align="start start">
                                    <div class="userInfoSummary" style="width:100%;background: url('images/userassets/contactcoverimg/cover5.jpg');
...
<!--             <script src="shell_specific_components/controllers/duoworld-frameworkentrycontroller.js"></script> -->
            ...
            <script src="coreApplications/invoice-app/invoice-main.js"></script>
            <!-- endbuild -->
    </body>
